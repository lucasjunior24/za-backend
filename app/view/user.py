...
@user_router.get("/user/{email}", tags=["users"])
...
@user_router.get("/users", tags=["users"], response_model=list[UserResponseDTO])
...
@user_router.post("/users", tags=["users"], response_model=UserResponseDTO) 
